      ...
      <div className="container flex min-h-[60dvh] items-center">
        <div className="flex flex-col gap-10 pt-12.5 sm:gap-20 lg:pt-56">
          <div className="flex flex-col gap-10 sm:gap-16 lg:flex-row-reverse lg:items-center lg:justify-between">
            <p className="text-paragraph max-w-60 text-sm leading-relaxed">
              درباره روان‌درمانی، رویکرد درمانی، خدمات مشاوره و شیوه همراهی ما با مراجعان بیشتر
              بدانید.
            </p>
            <h1 className="font-secondary max-w-105 text-6xl leading-snug whitespace-pre-wrap md:max-w-170 md:text-[85px]">
              آشنایی با رویکرد های درمانی و<span className="text-primary"> ارزش های ما</span>
            </h1>
          </div>
          <h5 className="text-2xl leading-relaxed whitespace-pre-wrap lg:flex">
