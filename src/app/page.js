    ...
    <>
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 z-2 container">
          <div
            ref={textContainer}
            className="flex h-dvh max-h-210 items-center justify-center text-white md:max-h-200"
          >
          ...
          <div
            ref={toggleContainer}
            className="flex h-dvh items-center justify-center pt-10 text-center md:max-h-180 md:pt-0"
          >
        ...
        <div
          className="relative flex h-dvh max-h-225 max-w-full items-end justify-center"
          ref={imgContainerRef}
        >
          <div
            ref={img1}
            className="absolute inset-0 z-1 flex h-dvh w-full items-center justify-between bg-[url(/images/banner.jpg)] bg-cover bg-top bg-no-repeat"
          ></div>
          <div
            ref={img2}
            className="absolute inset-0 h-dvh w-full bg-[url(/images/banner-2.jpg)] bg-cover bg-center bg-no-repeat"
          ></div>
        </div>
      </div>
    </>
